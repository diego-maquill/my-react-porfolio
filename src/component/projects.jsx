				...
				<div id="my-projects" className="container-fluid bg-light mt-5">
					<div className=" project-container container bg-light pb-5">
						...
						<div className="row my-5">
							...
							<div class="col-12 col-sm-12 col-md-4 ">
								<h5>This project is a combination of NodeJS, MongoDB, Express, Passport, HTML ,and Bootstrap CSS. An eCommerce application for farmers market. The idea was to create a shopping cart for people who want to shop at farmer's market major cities throughout the United States. Most of these farmers market are rotating farmers market and they do not have access to sell through website application. </h5>
							</div>
							<div class="col-12 col-sm-12 col-md-4 ">
